...
[![Build Status](https://travis-ci.org/cheekybits/genny.svg?branch=master)](https://travis-ci.org/cheekybits/genny) [![GoDoc](https://godoc.org/github.com/noho-digital/genny/parse?status.png)](http://godoc.org/github.com/noho-digital/genny/parse)

Install:

```
go get github.com/noho-digital/genny
```
...
We have started building a [library of common things](https://github.com/noho-digital/gennylib), and you can use `genny get` to generate the specific versions you need.
...
To see a real example of how to use `genny` with `go generate`, look in the [example/go-generate directory](https://github.com/noho-digital/genny/tree/master/examples/go-generate).
...
Given [this generic Go code](https://github.com/noho-digital/genny/tree/master/examples/queue) which compiles and is tested:
...
Check out the [test code files](https://github.com/noho-digital/genny/tree/master/parse/test) for more real examples.
...
### Contributions
  ...
  * See the [API documentation for the parse package](http://godoc.org/github.com/noho-digital/genny/parse)
  * Please do TDD
  * All input welcome
